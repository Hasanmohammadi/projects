    ...
    <DatePickerStyledContainer>
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <DatePickerStyledContainer
            className={clsx(
              'flex cursor-pointer flex-wrap gap-2 border pl-3 pr-1 border-gray-300 rounded-lg items-center relative',
              className,
              size,
            )}
          >
            {iconPosition === 'left' && (
              <Calendar
                size={20}
                className="cursor-default absolute left-2"
                color="#667085"
              />
            )}
            ...
            {type === 'RangeDay' && (
              <div
                className={clsx('RangeDay', {
                  'absolute right-0': iconPosition === 'left',
                  'absolute left-0': iconPosition === 'right',
                })}
              >
                <DatePickerCP
                  onChange={onChange}
            ...
            {iconPosition === 'right' && (
              <Calendar
                size={20}
                className="cursor-default absolute right-2"
                color="#667085"
              />
            )}
          </DatePickerStyledContainer>
